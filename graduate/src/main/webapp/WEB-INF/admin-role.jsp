...
<body>
	<nav class="breadcrumb">
		...
		身份管理 <span class="c-gray en">&gt;</span> 角色管理 <a
	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray">
			<span class="l"> <a class="btn btn-primary radius"
				href="javascript:;"
				onclick="admin_role_add('添加角色','/Super/add','400','400')"><i
				...
				<c:forEach items="${user}" var="rl">
					<tr class="text-c">
						...
						<td class="f-14"><a title="删除" href="javascript:;"
							onclick="admin_role_del(this,'${rl.id}')" class="ml-5"
